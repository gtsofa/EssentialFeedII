...
final class FeedImageDataLoaderWithFallbackCompositeTests: XCTestCase {
    ...
    func test_loadImageData_loadsFromFallbackLoaderOnPrimaryLoaderFailure() {
        ...
        XCTAssertEqual(primaryLoader.loadedURLs, [url], "Expected to load image URL from primary loader")
        XCTAssertEqual(fallbackLoader.loadedURLs, [url], "Expected to loaded image URL from fallback loader")
    }
    ...
    func test_cancelLoadImageData_cancelsPrimaryLoaderTask() {
        ...
        XCTAssertEqual(primaryLoader.cancelledURLs, [url], "Expected to cancel URL loading from primary laoder")
